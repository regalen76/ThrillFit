...
import 'package:thrill_fit/screens/feeds/followers/feeds_followers_view_model.dart';
...
class FeedsFollowersView extends StatelessWidget {
  const FeedsFollowersView({super.key});

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder.reactive(
        viewModelBuilder: () => FeedsFollowersViewModel(),
                      ...
                      children: [
                        Container(
                          ...
                          child: FirestorePagination(
                              isLive: true,
                              query: model.getPostsFollowedQuery(),
                                ...
                                return Column(
                                  children: [
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        if (snapshot.connectionState ==
                                                                          ...
                                                                          return Expanded(
                                                                              child: Container(
                                                                            decoration:
                                                                                BoxDecoration(borderRadius: BorderRadius.circular(20), image: DecorationImage(image: NetworkImage(snapshot.data!), fit: BoxFit.contain)),
                                                                          ));
                                                                        }
                                                                      }),
                                                                if (MediaType()
                                    ...
                                    SizedBox(
                                      ...
                                      children: [
                                        StreamProvider<
                                                List<PostLikesModel>>.value(
                                            value: model
                                                .getPostLikesStreamFromUser(
                                                    dataSnapshot.id),
                                            initialData: const [],
                                            child:
                                                Consumer<List<PostLikesModel>>(
                                                                ...
                                                                return ListView
                                                                  ...
                                                                  itemBuilder:
                                                                      (context,
                                                                          index) {
                                                                    return FutureBuilder(
                                                                        future: model.getUserName(postData
                                                                            .author),
                                                                        builder:
                                                                            (context,
                                                                                snapshot2) {
